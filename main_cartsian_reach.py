...
env = gym.make('PandaReachDense-v3', render_mode="rgb_array",renderer="OpenGL")
MAX_EPISODES = 1000
MAX_STEPS = 200
MAX_BUFFER = 1000000
MAX_TOTAL_REWARD = 300
S_DIM = env.observation_space['desired_goal'].shape[0]
# S_DIM = env.observation_space['observation'].shape[0]
...
for _ep in range(MAX_EPISODES):
    ...
    for r in range(MAX_STEPS):
        state = observation['desired_goal'][0:3] - observation["observation"][0:3]
        ...
        if terminated or truncated:
            ...
            new_state = new_observation['desired_goal'][0:3] - new_observation["observation"][0:3]
